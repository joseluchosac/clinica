    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            {/* {(flash?.success || flash?.error) && (
                <Alert variant={flash?.error ? 'destructive' : 'default'} className="bg-green-400">
                                        ...
                                        <TableRow key={patient.id} className={patient.debugged ? 'text-orange-700 dark:text-orange-300' : ''}>
                                            <TableCell className='p-1'>
                                                <DropdownMenu>
                                                    <DropdownMenuTrigger asChild>
                                                        <Button size='sm' variant="ghost" className='px-2'><EllipsisVertical /></Button>
                                                    </DropdownMenuTrigger>
                                                    <DropdownMenuContent>
                                                        <DropdownMenuItem
                                                            title='Eliminar'
                                                        ...
                                                        <DropdownMenuItem
                                                            ...
                                                            onClick={() => imprimirHcClasica(patient.id)}
                                                        >
                                                            <Printer /> HC clásica
                                                        </DropdownMenuItem>
                                                        <DropdownMenuItem
                                            ...
                                            <TableCell className='px-2 py-1'>
                                                <div className='max-w-[15vw]'>
                                                    <div className='text-nowrap truncate'>{patient.address}</div>
                                                    <div className='text-nowrap truncate'>
                                                        <small>{patient.location_address_name}</small>
                                                    </div>
                                                </div>
                                            </TableCell>
                                            <TableCell className='text-nowrap px-2 py-1'>{patient.entry_at?.split(' ')[0]}</TableCell>
                                        </TableRow>
                                    ))
                                ) : (
                                    <TableRow>
